...
class FixedGridODESolver(metaclass=abc.ABCMeta):
    ...
    def __init__(self, func, y0, step_size=None, grid_constructor=None, interp="linear", perturb=False, force=None, **unused_kwargs):
    ...
    def integrate(self, t):
        ...
        self.force.init_loop(self.forcing_tensor)

        for t0, t1 in zip(time_grid[:-1], time_grid[1:]):
            
            forced_term = self.force.step_loop()

            dt = t1 - t0
            dy, f0 = self._step_func(self.func, t0, dt, t1, y0)
            y1 = y0 + dy + forced_term
